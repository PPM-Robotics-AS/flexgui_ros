angular.module('ui.bootstrap-slider', [])
    .directive('slider', ['$parse', '$timeout', '$rootScope', function ($parse, $timeout, $rootScope) {
        return {
            restrict: 'AE',
            replace: true,
            template: '<div><input class="slider-input" type="text" style="width:100%; height:100%" /></div>',
            require: 'ngModel',
            scope: {
                max: "=",
                min: "=",
            ...
            link: function ($scope, element, attrs, ngModelCtrl, $compile) {
                ...
                function initSlider() {
                    ...
                    setOption('orientation', $scope.orientation, 'horizontal');
                ...
                var watchers = ['min', 'max', 'step', 'range', 'scale', 'ticksLabels', 'orientation'];
                angular.forEach(watchers, function (prop) {
                    $scope.$watch(prop, function (nv) {
                        slider = initSlider();
                    });
                });
